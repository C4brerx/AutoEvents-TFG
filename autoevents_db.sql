...
-- Volcando estructura de base de datos para autoevents_db
CREATE DATABASE IF NOT EXISTS `autoevents_db` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */;
USE `autoevents_db`;

-- Volcando estructura para tabla autoevents_db.asistencias
...
-- Volcando datos para la tabla autoevents_db.asistencias: ~0 rows (aproximadamente)

-- Volcando estructura para tabla autoevents_db.eventos
...
-- Volcando datos para la tabla autoevents_db.usuarios: ~1 rows (aproximadamente)
...
INSERT INTO `vehiculos` (`id`, `usuario_id`, `marca`, `modelo`, `anio`, `motor`, `especificaciones`, `modificaciones`, `fotos`) VALUES
	...
	(5, 4, 'BMW', 'M4 Competicione', 2022, '3.0L S58', ' motor gasolina 3.0L TwinPower Turbo de 6 cilindros en línea, con potencias de 480 CV (base) a 510 CV (Competition) y hasta 650 Nm de par, asociado a tracción trasera o M xDrive y cambio automático de 8 velocidades. Es conocido por su aceleración de 0 a 100 km/h en 3,9 segundos', NULL, '1773937634-9008-2022-bmw-m4-csl.webp,1773937634-7149-2022-bmw-m4-csl-15.jpg');
